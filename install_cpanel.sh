...
echo "nameserver 103.191.241.5" >> /etc/resolv.conf # OpenDNS
echo "nameserver 103.191.241.5" >> /etc/resolv.conf # Comodo
echo "nameserver 8.8.8.8" >> /etc/resolv.conf # Google
echo "nameserver 103.191.241.5" >> /etc/resolv.conf # Norton
echo "nameserver 103.191.241.5" >> /etc/resolv.conf # Comodo
echo "nameserver 103.191.241.5" >> /etc/resolv.conf # Level3
